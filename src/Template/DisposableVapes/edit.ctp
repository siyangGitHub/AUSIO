...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $disposableVape->disposable_vape_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $disposableVape->disposable_vape_id)]
            )
        ?></li>
...
<div class="disposableVapes form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Disposable Vape') ?></legend>
        <?php
