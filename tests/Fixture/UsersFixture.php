...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_role' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'user_status' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'user_contact' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['user_id'], 'length' => []],
            'users_user_id_uindex' => ['type' => 'unique', 'columns' => ['user_id'], 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'user_role' => 1,
                'user_status' => 1,
                'user_contact' => 'Lorem ipsum dolor sit amet',
            ],
        ];
        parent::init();
    }
